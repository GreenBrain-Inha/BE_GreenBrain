...
```bash
python3 scripts/execute.py {task-name}                         # Claude로 순차 실행
python3 scripts/execute.py {task-name} --executor codex         # Codex로 순차 실행
python3 scripts/execute.py {task-name} --push                   # Claude로 실행 후 push
python3 scripts/execute.py {task-name} --executor codex --push  # Codex로 실행 후 push
```
